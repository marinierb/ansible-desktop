...
1. Launch Dropbox (there is a Gnome launcher for it) and go through the setup
...
1. Ensure that the required secrets are set up
        ...
        ansible-vault view \
          --vault-password-file /home/bruno/Dropbox/ansible-vault/password \
          /home/bruno/Dropbox/ansible-vault/vault.yml
